...
const DOCUMENTS = [
  {
    ...
    description: 'Accuracy, AUC, precision/recall, and feature importance for the facility underperformance prediction models (Logistic Regression, Random Forest, XGBoost).',
    category: 'Machine Learning',
    filename: 'ml-model-performance.pdf',
    size: null,   // e.g. '1.2 MB' — fill in once file is added
  },
  // ── Add more documents here ──────────────────────────────────────────────
  // {
  //   id: 2,
  //   title: 'Capstone Presentation',
  //   description: 'MBA capstone slide deck presented to the ACE Capital investment committee.',
  //   category: 'Presentation',
  //   filename: 'capstone-presentation.pdf',
  //   size: '4.5 MB',
  // },
]
              ...
              <div key={doc.id} className="doc-card">
                ...
                <div className="doc-footer">
                  ...
                  <a
                    ...
                    onClick={e => {
                      // Warn gracefully if file hasn't been added yet
